...
"https://www.kernel.org/pub/linux/kernel/v5.x/linux-5.15.117.tar.xz"
"https://ftp.gnu.org/gnu/m4/m4-1.4.19.tar.xz"
"https://ftp.gnu.org/gnu/make/make-4.4.tar.gz"
"https://download.savannah.gnu.org/releases/man-db/man-db-2.11.2.tar.xz"
"https://www.kernel.org/pub/linux/docs/man-pages/man-pages-6.03.tar.xz"
...
"https://www.linuxfromscratch.org/patches/lfs/11.3/bzip2-1.0.8-install_docs-1.patch"
"https://www.linuxfromscratch.org/patches/lfs/11.3/coreutils-9.1-i18n-1.patch"
"https://www.linuxfromscratch.org/patches/lfs/11.3/glibc-2.37-fhs-1.patch"
"https://www.linuxfromscratch.org/patches/lfs/11.3/grub-2.06-upstream_fixes-1.patch"
"https://www.linuxfromscratch.org/patches/lfs/11.3/kbd-2.5.1-backspace-1.patch"
"https://www.linuxfromscratch.org/patches/lfs/11.3/readline-8.2-upstream_fix-1.patch"
"https://www.linuxfromscratch.org/patches/lfs/11.3/sysvinit-3.06-consolidated-1.patch")
...
for url in "${urls[@]}"; do
  ...
  if curl --output /dev/null --silent --head --fail "$url"; then
    ...
    echo "File $filename is not available"
  fi
done